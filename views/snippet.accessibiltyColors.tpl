...
/* ---------------------------------------------------------------- */
/*     9. ALL BUTTONS except slider button and timeline button      */
/* ---------------------------------------------------------------- */
...
/* ------------------------------------------------------------- */
/*    16. NAV HOVER BG COLOR FOR NON-ACTIVE DROPDOWN ITEMS       */
/* ------------------------------------------------------------- */
